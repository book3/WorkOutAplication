...
//  WorkOutAplication
//
//  Created by Yntymak on 15/11/22.
//
...
final class TimerView: WABaseInfoView {
    ...
    private let elapsedTimeLable: UILabel = {
        let lable = UILabel()
        lable.text = R.Strings.Sessions.elapsedTime
        lable.font = R.Fonts.helveticaRegular(with: 14)
    ...
    private let elapsedTimeValueLable: UILabel = {
        let lable = UILabel()
        lable.font = R.Fonts.helveticaRegular(with: 46)
    ...
    private let remainingTimeLable: UILabel = {
        let lable = UILabel()
        lable.text = R.Strings.Sessions.remainingTime
    ...
    func configure(with duration: Double, progress: Double) {
        ...
        completedPercentView.configure(with: R.Strings.Sessions.elapsedTime.uppercased(),
                                       andValue: roundedPercent)
        remainigPercetnView.configure(with: R.Strings.Sessions.remainingTime.uppercased(),
